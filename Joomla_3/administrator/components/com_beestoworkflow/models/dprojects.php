...
class BeestoWorkflowModelDProjects extends JModelForm
{
	private $_context = 'com_beestoworkflow.dprojects';
	...
	{
		// Get the form.
		$form = $this->loadForm('com_beestoworkflow.dprojects', 'dprojects', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
