...
class BeestoWorkflowViewStep extends JViewLegacy
{
	protected $item;
	protected $form;
	protected $state;
	...
	protected function addToolbar() {
		...
		if ($isNew) {
			JToolBarHelper::title(   'beestoworkflow :: ' . JText::_( 'COM_BEESTOWORKFLOW_WORKFLOWS_STEPS_TASKS_ADD' ), 'workflows' );	
		} else {
			JToolBarHelper::title(   'beestoworkflow :: ' . JText::_( 'COM_BEESTOWORKFLOW_WORKFLOWS_STEPS_TASKS_EDIT' ), 'workflows' );	
		}
