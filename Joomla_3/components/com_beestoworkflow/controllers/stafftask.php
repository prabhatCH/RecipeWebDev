...
class BeestoWorkflowControllerStaffTask extends JControllerForm {
	...
	public function add () {
		...
		$project 	= JRequest::getVar('project',null,'','int');
		$app->setUserState('com_beestoworkflow.session.project', $project);
